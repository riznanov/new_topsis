                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kepentingan" id="kepentingan">
												<option value='1' <?php if($row["kepentingan"]==1) echo "selected"?>>Sangat Rendah</option>
												<option value='2' <?php if($row["kepentingan"]==2) echo "selected"?>>Rendah</option>
												<option value='3' <?php if($row["kepentingan"]==3) echo "selected"?>>Cukup</option>
												<option value='4' <?php if($row["kepentingan"]==4) echo "selected"?>>Tinggi</option>
												<option value='5' <?php if($row["kepentingan"]==5) echo "selected"?>>Sangat Tinggi</option>
										    </select>
										</div>
										<div class="form-group">
