...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title><?php echo $_SESSION['welcome'];?></title>
							...
							<form role="form" method="post" action="editk.php?id=<?php echo $_GET['id'];?>">
                                 <div class="box-body">
										<div class="form-group">
                                            <label for="alternatif">NIK</label>
                                            <input type="text" class="form-control" name="kode_karyawan" id="alternatif" placeholder="NIK" value="<?php echo $alt["kode_karyawan"]?>" required >
                                        </div>
										<div class="form-group">
